...
extern const OpcodeSpec<uint32_t> sampleCount { 0, Range<uint32_t>(0, uint32_t_max), kIsResetBelowLowerBound };
extern const OpcodeSpec<uint32_t> loopStart { 0, Range<uint32_t>(0, uint32_t_max), kIsResetBelowLowerBound };
extern const OpcodeSpec<uint32_t> loopEnd { uint32_t_max, Range<uint32_t>(0, uint32_t_max), kIsResetBelowLowerBound };
extern const OpcodeSpec<uint32_t> loopCount { 0, Range<uint32_t>(0, uint32_t_max), kIsResetBelowLowerBound };
extern const OpcodeSpec<float> loopCrossfade { 1e-3, Range<float>(1e-3, 1.0f), kEnforceLowerBound };
...
extern const OpcodeSpec<int> oscillatorMode { 0, Range<int>(0, 2), kIsResetBelowLowerBound };
extern const OpcodeSpec<int> oscillatorMulti { 1, Range<int>(1, config::oscillatorsPerVoice), kIsResetBelowLowerBound };
...
extern const OpcodeSpec<int> oscillatorQuality { 1, Range<int>(0, 3), kIsResetBelowLowerBound };
extern const OpcodeSpec<uint32_t> group { 0, Range<uint32_t>(0, uint32_t_max), kIsResetBelowLowerBound };
extern const OpcodeSpec<float> offTime { 6e-3f, Range<float>(0.0f, 100.0f), kIsResetBelowLowerBound };
...
extern const OpcodeSpec<uint8_t> key { 60, Range<uint8_t>(0, 127), kCanBeNote|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<uint8_t> loKey { 0, Range<uint8_t>(0, 127), kCanBeNote|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<uint8_t> hiKey { 127, Range<uint8_t>(0, 127), kCanBeNote|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> loCC { 0, Range<float>(0.0f, 127.0f), kNormalizeMidi|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> hiCC { 127, Range<float>(0.0f, 127.0f), kNormalizeMidi|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> loHDCC { 0.0f, Range<float>(0.0f, 1.0f), kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> hiHDCC { 1.0f, Range<float>(0.0f, 1.0f), kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> loVel { 0, Range<float>(0.0f, 127.0f), kNormalizeMidi|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> hiVel { 127, Range<float>(0.0f, 127.0f), kNormalizeMidi|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<uint8_t> loChannelAftertouch { 0, Range<uint8_t>(0, 127), kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<uint8_t> hiChannelAftertouch { 127, Range<uint8_t>(0, 127), kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> loBend { -8192, Range<float>(-8192.0f, 8192.0f), kNormalizeBend|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> hiBend { 8192, Range<float>(-8192.0f, 8192.0f), kNormalizeBend|kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> loRand { 0.0f, Range<float>(0.0f, 1.0f), kEnforceUpperBound|kIsResetBelowLowerBound };
extern const OpcodeSpec<float> hiRand { 1.0f, Range<float>(0.0f, 1.0f), kEnforceUpperBound|kIsResetBelowLowerBound };
...
extern const OpcodeSpec<float> loBPM { 0.0f, Range<float>(0.0f, 500.0f), kIsResetBelowLowerBound };
extern const OpcodeSpec<float> hiBPM { 500.0f, Range<float>(0.0f, 500.0f), kIsResetBelowLowerBound };
extern const OpcodeSpec<uint8_t> sequence { 1, Range<uint8_t>(1, 100), kIsResetBelowLowerBound };
...
extern const OpcodeSpec<float> eqBandwidth { 1.0f, Range<float>(0.0f, 4.0f), kIsResetBelowLowerBound };

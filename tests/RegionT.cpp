...
TEST_CASE("[Region] Parsing opcodes")
{
    ...
    SECTION("pan_oncc")
    {
        ...
        REQUIRE(region.modifiers[Mod::pan][45].value == 0.042_a);
        ...
        REQUIRE(region.modifiers[Mod::pan][120].step == 0.24_a);
        region.parseOpcode({ "pan_stepcc120", "15482" });
        REQUIRE(region.modifiers[Mod::pan][120].step == 2.0_a);
    ...
    SECTION("width_oncc")
    {
        ...
        REQUIRE(region.modifiers[Mod::width][45].value == 0.042_a);
        ...
        REQUIRE(region.modifiers[Mod::width][120].step == 0.24_a);
        region.parseOpcode({ "width_stepcc120", "15482" });
        REQUIRE(region.modifiers[Mod::width][120].step == 2.0_a);
    ...
    SECTION("position_oncc")
    {
        ...
        REQUIRE(region.modifiers[Mod::position][45].value == 0.042_a);
        ...
        REQUIRE(region.modifiers[Mod::position][120].step == 0.24_a);
        region.parseOpcode({ "position_stepcc120", "15482" });
        REQUIRE(region.modifiers[Mod::position][120].step == 2.0_a);
    ...
    SECTION("amplitude_cc")
    {
        ...
        REQUIRE(region.modifiers[Mod::amplitude][1].value == 0.40_a);
        region.parseOpcode({ "amplitude_oncc2", "30" });
        REQUIRE(region.modifiers[Mod::amplitude].contains(2));
        REQUIRE(region.modifiers[Mod::amplitude][2].value == 0.30_a);
        ...
        REQUIRE(region.modifiers[Mod::amplitude][120].step == 0.24_a);
        region.parseOpcode({ "amplitude_stepcc120", "15482" });
        REQUIRE(region.modifiers[Mod::amplitude][120].step == 1.0_a);
    ...
    SECTION("volume_oncc/gain_cc")
    {
        ...
        REQUIRE(region.modifiers[Mod::volume][120].step == 48.0f);
